...
static void*                   hoolFuncAddress_ = nullptr;

auto kiero::Init(RenderType::Enum _renderType) -> Status::Enum {
...
auto kiero::Bind(uint16_t _index, void* _function) -> Status::Enum {
...
auto kiero::GetMethodsTable() -> uint150_t* { return g_methodsTable; }
